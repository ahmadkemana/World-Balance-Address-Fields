...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-address-field/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const [cities, setCities] = (0, import_react15.useState)([]);
    const [selectedCity, setSelectedCity] = (0, import_react15.useState)("");
    const [selectedCityErr, setSelectedCityErr] = (0, import_react15.useState)("");
    const [districts, setDistricts] = (0, import_react15.useState)([]);
    const [selectedDistrict, setSelectedDistrict] = (0, import_react15.useState)("");
    const [selectedDistrictErr, setSelectedDistrictErr] = (0, import_react15.useState)("");
    const [subdistricts, setSubdistricts] = (0, import_react15.useState)([]);
    const [selectedSubdistrict, setSelectedSubdistrict] = (0, import_react15.useState)("");
    const [selectedSubdistrictErr, setSelectedSubdistrictErr] = (0, import_react15.useState)("");
    const [loading, setLoading] = (0, import_react15.useState)(false);
    const canBlockProgress = useExtensionCapability("block_progress");
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && selectedCity === "" && (cities == null ? void 0 : cities.length) > 0 && (settings == null ? void 0 : settings.city_field) === "Yes") {
        return {
          behavior: "block",
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedCityErr(
                `${((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.validation_message_city_ENG) !== null ? settings == null ? void 0 : settings.validation_message_city_ENG : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.validation_message_city_ENG) == null ? "City is required" : (settings == null ? void 0 : settings.validation_message_city_translated) == null ? "Kota Diperlukan" : settings == null ? void 0 : settings.validation_message_city_translated}`
              );
            }
          }
        };
      }
      if (canBlockProgress2 && selectedDistrict === "" && (districts == null ? void 0 : districts.length) > 0 && (settings == null ? void 0 : settings.district_field) === "Yes") {
        return {
          behavior: "block",
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedDistrictErr(
                `${((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.validation_message_district_ENG) !== null ? settings == null ? void 0 : settings.validation_message_district_ENG : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.validation_message_district_ENG) == null ? "District is required" : (settings == null ? void 0 : settings.validation_message_district_translated) == null ? "Kelurahan Diperlukan" : settings == null ? void 0 : settings.validation_message_district_translated}`
              );
            }
          }
        };
      }
      if (canBlockProgress2 && selectedSubdistrict === "" && (subdistricts == null ? void 0 : subdistricts.length) > 0 && (settings == null ? void 0 : settings.subdistrict_field) === "Yes") {
        return {
          behavior: "block",
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedSubdistrictErr(
                `${((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.validation_message_subdistrict_ENG) !== null ? settings == null ? void 0 : settings.validation_message_subdistrict_ENG : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.validation_message_subdistrict_ENG) == null ? "Sub district is Required" : (settings == null ? void 0 : settings.validation_message_subdistrict_translated) == null ? "Kecamatan Diperlukan" : settings == null ? void 0 : settings.validation_message_subdistrict_translated}`
              );
            }
          }
        };
    ...
    (0, import_react15.useEffect)(() => {
      if (!(settings == null ? void 0 : settings.addresses_file_url) || !(address == null ? void 0 : address.countryCode))
        return;
      fetch(settings == null ? void 0 : settings.addresses_file_url).then((response) => response.json()).then((jsonData) => {
        const filteredData = jsonData == null ? void 0 : jsonData.filter(
          (item) => (item == null ? void 0 : item.country_id) === (address == null ? void 0 : address.countryCode)
        );
    ...
    }, [settings == null ? void 0 : settings.addresses_file_url, address == null ? void 0 : address.countryCode]);
    (0, import_react15.useEffect)(() => {
      setSelectedCity("");
      setSelectedDistrict("");
      ...
      setSubdistricts([]);
      setDistricts([]);
      if ((settings == null ? void 0 : settings.city_field) === "No") {
        const filteredDistricts = data == null ? void 0 : data.filter(
          (location) => (location == null ? void 0 : location.region_code) === (address == null ? void 0 : address.provinceCode)
        ).map((location) => location == null ? void 0 : location.district);
        setDistricts([...new Set(filteredDistricts)]);
      } else {
        const filteredCities = data == null ? void 0 : data.filter(
          (location) => (location == null ? void 0 : location.region_code) === (address == null ? void 0 : address.provinceCode)
        );
        const uniqueCities = [
          ...new Set(filteredCities.map((city) => city == null ? void 0 : city.city))
        ];
        setCities(uniqueCities);
      }
    }, [data, address == null ? void 0 : address.provinceCode, settings == null ? void 0 : settings.city_field]);
    const handleCityChange = (value) => __async(this, null, function* () {
      setSelectedCity(value);
      setSelectedCityErr("");
      setSelectedDistrict("");
      setSelectedSubdistrict("");
      const selectedCityDistricts = data == null ? void 0 : data.filter((city) => (city == null ? void 0 : city.city) === value).map((city) => city == null ? void 0 : city.district);
      setDistricts([...new Set(selectedCityDistricts)]);
    });
    (0, import_react15.useEffect)(() => {
      const updateAttribute = () => __async(this, null, function* () {
        const result = yield applyAttributeChange({
          type: "updateAttribute",
          key: (settings == null ? void 0 : settings.target_save_note_key_for_city) == null ? "City" : `${settings == null ? void 0 : settings.target_save_note_key_for_city}`,
          value: `${selectedCity}`
        });
      });
      updateAttribute();
    }, [settings == null ? void 0 : settings.target_save_note_key_for_city, selectedCity]);
    const handleDistrictChange = (value) => __async(this, null, function* () {
      setSelectedDistrictErr("");
      setSelectedDistrict(value);
      setSelectedSubdistrict("");
      const selectedDistrictSubdistricts = data == null ? void 0 : data.filter((location) => {
        if ((settings == null ? void 0 : settings.city_field) === "No") {
          return (location == null ? void 0 : location.region_code) === (address == null ? void 0 : address.provinceCode) && (location == null ? void 0 : location.district) === value;
        } else {
          return (location == null ? void 0 : location.city) === selectedCity && (location == null ? void 0 : location.district) === value;
        }
      }).map((location) => location == null ? void 0 : location.subdistrict);
    ...
    (0, import_react15.useEffect)(() => {
      const updateAttribute = () => __async(this, null, function* () {
        const result = yield applyAttributeChange({
          type: "updateAttribute",
          key: (settings == null ? void 0 : settings.target_save_note_key_for_district) == null ? "District" : `${settings == null ? void 0 : settings.target_save_note_key_for_district}`,
          value: `${selectedDistrict}`
        });
      });
      updateAttribute();
    }, [settings == null ? void 0 : settings.target_save_note_key_for_district, selectedDistrict]);
    const handleSubdistrictChange = (value) => __async(this, null, function* () {
    ...
    (0, import_react15.useEffect)(() => {
      const updateAttribute = () => __async(this, null, function* () {
        const result = yield applyAttributeChange({
          type: "updateAttribute",
          key: (settings == null ? void 0 : settings.target_save_note_key_for_subdistrict) == null ? "Subdistrict" : `${settings == null ? void 0 : settings.target_save_note_key_for_subdistrict}`,
          value: `${selectedSubdistrict}`
        });
      });
      updateAttribute();
    }, [settings == null ? void 0 : settings.target_save_note_key_for_subdistrict, selectedSubdistrict]);
    const activeFields = [
      (settings == null ? void 0 : settings.city_field) === "Yes",
      (settings == null ? void 0 : settings.district_field) === "Yes",
      (settings == null ? void 0 : settings.subdistrict_field) === "Yes"
    ...
    return (address == null ? void 0 : address.countryCode) == (settings == null ? void 0 : settings.country_code) ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Grid2, { columns: gridColumns, spacing: "loose", children: loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        View2,
        {
          ...
          borderRadius: "base",
          padding: "base",
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SkeletonText2, { size: "small" })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        View2,
      ...
      (settings == null ? void 0 : settings.city_field) && settings.city_field === "Yes" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Select2,
        {
          label: ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_city_ENG) == null ? `${selectedCity == "" ? "Select City" : "City"}` : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_city_ENG) !== null ? `${selectedCity == "" ? `Select ${settings == null ? void 0 : settings.label_city_ENG}` : settings == null ? void 0 : settings.label_city_ENG}` : ((language == null ? void 0 : language.isoCode) !== "en" || (language == null ? void 0 : language.isoCode) !== `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_city_translated) == null ? `${selectedCity == "" ? settings == null ? void 0 : settings.label_city_translated : settings == null ? void 0 : settings.label_city_translated}` : `${selectedCity == "" ? settings == null ? void 0 : settings.label_city_translated : settings == null ? void 0 : settings.label_city_translated}`,
          value: selectedCity,
          options: cities == null ? void 0 : cities.map((city) => ({
            value: city,
            label: city
          })),
      ...
      (settings == null ? void 0 : settings.district_field) && settings.district_field === "Yes" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Select2,
        {
          label: ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_district_ENG) == null ? `${selectedDistrict == "" ? "Select District" : "District"}` : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_district_ENG) !== null ? `${selectedDistrict == "" ? `Select ${settings == null ? void 0 : settings.label_district_ENG}` : settings == null ? void 0 : settings.label_district_ENG}` : ((language == null ? void 0 : language.isoCode) !== "en" || (language == null ? void 0 : language.isoCode) !== `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_district_translated) == null ? `${selectedDistrict == "" ? settings == null ? void 0 : settings.label_district_translated : settings == null ? void 0 : settings.label_district_translated}` : `${selectedDistrict == "" ? settings == null ? void 0 : settings.label_district_translated : settings == null ? void 0 : settings.label_district_translated}`,
          value: selectedDistrict,
          options: districts == null ? void 0 : districts.map((district) => ({
            value: district,
            label: district
          })),
      ...
      (settings == null ? void 0 : settings.subdistrict_field) && settings.subdistrict_field === "Yes" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Select2,
        {
          label: ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_subdistrict_ENG) == null ? `${selectedSubdistrict == "" ? "Select Subdistrict" : "Subdistrict"}` : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_subdistrict_ENG) !== null ? `${selectedSubdistrict == "" ? `Select ${settings == null ? void 0 : settings.label_subdistrict_ENG}` : settings == null ? void 0 : settings.label_subdistrict_ENG}` : ((language == null ? void 0 : language.isoCode) !== "en" || (language == null ? void 0 : language.isoCode) !== `en-${settings == null ? void 0 : settings.country_code}`) && (settings == null ? void 0 : settings.label_subdistrict_translated) == null ? `${selectedSubdistrict == "" ? settings == null ? void 0 : settings.label_subdistrict_translated : settings == null ? void 0 : settings.label_subdistrict_translated}` : `${selectedSubdistrict == "" ? settings == null ? void 0 : settings.label_subdistrict_translated : settings == null ? void 0 : settings.label_subdistrict_translated}`,
          value: selectedSubdistrict,
          options: subdistricts == null ? void 0 : subdistricts.map((subdistrict) => ({
            value: subdistrict,
            label: subdistrict
          })),
...
//# sourceMappingURL=checkout-address-field.js.map
