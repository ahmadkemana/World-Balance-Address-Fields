...
${errorInfo.componentStack}`);
  ...
  function Extension() {
        ...
        return {
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedCityErr(
                `${(language == null ? void 0 : language.isoCode) == "en" ? settings == null ? void 0 : settings.validation_message_city_ENG : settings == null ? void 0 : settings.validation_message_city_IND}`
              );
            }
          }
        };
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedDistrictErr(
                `${(language == null ? void 0 : language.isoCode) == "en" ? settings == null ? void 0 : settings.validation_message_district_ENG : settings == null ? void 0 : settings.validation_message_district_IND}`
              );
            }
          }
        };
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedSubdistrictErr(
                `${(language == null ? void 0 : language.isoCode) == "en" ? settings == null ? void 0 : settings.validation_message_subdistrict_ENG : settings == null ? void 0 : settings.validation_message_subdistrict_IND}`
              );
            }
          }
        };
    ...
    const handleDistrictChange = (value) => __async(this, null, function* () {
      ...
      setSelectedSubdistrict("");
      const selectedDistrictSubdistricts = data == null ? void 0 : data.filter((city) => (city == null ? void 0 : city.district) === value).map((city) => city == null ? void 0 : city.subdistrict);
      ...
      Grid2,
      {
        ...
        children: loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Select2,
            {
              label: (language == null ? void 0 : language.isoCode) == "en" && (settings == null ? void 0 : settings.label_city_ENG) == null ? `${selectedCity == "" ? "Select City" : "City"}` : (language == null ? void 0 : language.isoCode) == "en" && (settings == null ? void 0 : settings.label_city_ENG) !== null ? `${selectedCity == "" ? `Select ${settings == null ? void 0 : settings.label_city_ENG}` : settings == null ? void 0 : settings.label_city_ENG}` : (language == null ? void 0 : language.isoCode) !== "en" && (settings == null ? void 0 : settings.label_city_IND) == null ? `${selectedCity == "" ? "Pilih Kota" : "Kota"}` : `${selectedCity == "" ? `Pilih ${settings == null ? void 0 : settings.label_city_IND}` : settings == null ? void 0 : settings.label_city_IND}`,
              value: selectedCity,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Select2,
            {
              label: (language == null ? void 0 : language.isoCode) == "en" && (settings == null ? void 0 : settings.label_district_ENG) == null ? `${selectedDistrict == "" ? "Select District" : "District"}` : (language == null ? void 0 : language.isoCode) == "en" && (settings == null ? void 0 : settings.label_district_ENG) !== null ? `${selectedDistrict == "" ? `Select ${settings == null ? void 0 : settings.label_district_ENG}` : settings == null ? void 0 : settings.label_district_ENG}` : (language == null ? void 0 : language.isoCode) !== "en" && (settings == null ? void 0 : settings.label_district_IND) == null ? `${selectedDistrict == "" ? "Pilih Daerah" : "Daerah"}` : `${selectedDistrict == "" ? `Pilih ${settings == null ? void 0 : settings.label_district_IND}` : settings == null ? void 0 : settings.label_district_IND}`,
              value: selectedDistrict,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Select2,
            {
              label: (language == null ? void 0 : language.isoCode) == "en" && (settings == null ? void 0 : settings.label_subdistrict_ENG) == null ? `${selectedSubdistrict == "" ? "Select Subdistrict" : "Subdistrict"}` : (language == null ? void 0 : language.isoCode) == "en" && (settings == null ? void 0 : settings.label_subdistrict_ENG) !== null ? `${selectedSubdistrict == "" ? `Select ${settings == null ? void 0 : settings.label_subdistrict_ENG}` : settings == null ? void 0 : settings.label_subdistrict_ENG}` : (language == null ? void 0 : language.isoCode) !== "en" && (settings == null ? void 0 : settings.label_subdistrict_IND) == null ? `${selectedSubdistrict == "" ? "Pilih Kecamatan" : "Kecamatan"}` : `${selectedSubdistrict == "" ? `Pilih ${settings == null ? void 0 : settings.label_subdistrict_IND}` : settings == null ? void 0 : settings.label_subdistrict_IND}`,
              value: selectedSubdistrict,
...
//# sourceMappingURL=ay-address-field.js.map
