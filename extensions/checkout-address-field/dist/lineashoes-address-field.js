...
${errorInfo.componentStack}`);
  ...
  // extensions/ay-address-field/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const [isLoadingCityChange, setIsLoadingCityChange] = (0, import_react15.useState)(false);
    const [isLoadingDistrictChange, setIsLoadingDistrictChange] = (0, import_react15.useState)(false);
    const canBlockProgress = useExtensionCapability("block_progress");
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && selectedCity === "") {
        return {
          behavior: "block",
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedCityErr(
                `${((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.validation_message_city_ENG) !== null ? settings == null ? void 0 : settings.validation_message_city_ENG : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.validation_message_city_ENG) == null ? "City is required" : (settings == null ? void 0 : settings.validation_message_city_IND) == null ? "Kota Diperlukan" : settings == null ? void 0 : settings.validation_message_city_IND}`
              );
            }
          }
        };
      }
      if (canBlockProgress2 && selectedDistrict === "") {
        return {
          behavior: "block",
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedDistrictErr(
                `${((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.validation_message_district_ENG) !== null ? settings == null ? void 0 : settings.validation_message_district_ENG : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.validation_message_district_ENG) == null ? "District is required" : (settings == null ? void 0 : settings.validation_message_district_IND) == null ? "Kelurahan Diperlukan" : settings == null ? void 0 : settings.validation_message_district_IND}`
              );
            }
          }
        };
      }
      if (canBlockProgress2 && selectedSubdistrict === "") {
        return {
          behavior: "block",
          ...
          perform: (result) => {
            if (result.behavior === "block") {
              setSelectedSubdistrictErr(
                `${((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.validation_message_subdistrict_ENG) !== null ? settings == null ? void 0 : settings.validation_message_subdistrict_ENG : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.validation_message_subdistrict_ENG) == null ? "Sub district is Required" : (settings == null ? void 0 : settings.validation_message_subdistrict_IND) == null ? "Kecamatan Diperlukan" : settings == null ? void 0 : settings.validation_message_subdistrict_IND}`
              );
            }
          }
        };
    ...
    (0, import_react15.useEffect)(() => {
      fetch(settings == null ? void 0 : settings.addresses_file_url).then((response) => response.json()).then((jsonData) => {
        setData(jsonData == null ? void 0 : jsonData.INDAddresses);
        setLoading(false);
      }).catch((error) => {
        console.error("Error fetching data:", error);
        setLoading(false);
      });
    }, [settings == null ? void 0 : settings.addresses_file_url]);
    (0, import_react15.useEffect)(() => {
      setSelectedCity("");
      setSelectedDistrict("");
      ...
      const filteredCities = data == null ? void 0 : data.filter(
        (location) => (location == null ? void 0 : location.code) === (address == null ? void 0 : address.provinceCode)
      );
      const uniqueCities = [
        ...new Set(filteredCities.map((city) => city == null ? void 0 : city.city))
      ];
      setCities(uniqueCities);
    }, [data, address == null ? void 0 : address.provinceCode]);
    ...
    const handleDistrictChange = (value) => __async(this, null, function* () {
      ...
      setSelectedSubdistrict("");
      const selectedDistrictSubdistricts = data == null ? void 0 : data.filter(
        (location) => (location == null ? void 0 : location.city) === selectedCity && (location == null ? void 0 : location.district) === value
    ...
    return (address == null ? void 0 : address.countryCode) == "ID" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Grid2,
      {
        columns: ["33.333333333%", "33.333333333%", "33.333333333%"],
        spacing: "loose",
        children: loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Select2,
            {
              label: ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_city_ENG) == null ? `${selectedCity == "" ? "Select City" : "City"}` : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_city_ENG) !== null ? `${selectedCity == "" ? `Select ${settings == null ? void 0 : settings.label_city_ENG}` : settings == null ? void 0 : settings.label_city_ENG}` : ((language == null ? void 0 : language.isoCode) !== "en" || (language == null ? void 0 : language.isoCode) !== "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_city_IND) == null ? `${selectedCity == "" ? "Pilih Kota" : "Kota"}` : `${selectedCity == "" ? `Pilih ${settings == null ? void 0 : settings.label_city_IND}` : settings == null ? void 0 : settings.label_city_IND}`,
              value: selectedCity,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Select2,
            {
              label: ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_district_ENG) == null ? `${selectedDistrict == "" ? "Select District" : "District"}` : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_district_ENG) !== null ? `${selectedDistrict == "" ? `Select ${settings == null ? void 0 : settings.label_district_ENG}` : settings == null ? void 0 : settings.label_district_ENG}` : ((language == null ? void 0 : language.isoCode) !== "en" || (language == null ? void 0 : language.isoCode) !== "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_district_IND) == null ? `${selectedDistrict == "" ? "Pilih Daerah" : "Daerah"}` : `${selectedDistrict == "" ? `Pilih ${settings == null ? void 0 : settings.label_district_IND}` : settings == null ? void 0 : settings.label_district_IND}`,
              value: selectedDistrict,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Select2,
            {
              label: ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_subdistrict_ENG) == null ? `${selectedSubdistrict == "" ? "Select Subdistrict" : "Subdistrict"}` : ((language == null ? void 0 : language.isoCode) == "en" || (language == null ? void 0 : language.isoCode) == "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_subdistrict_ENG) !== null ? `${selectedSubdistrict == "" ? `Select ${settings == null ? void 0 : settings.label_subdistrict_ENG}` : settings == null ? void 0 : settings.label_subdistrict_ENG}` : ((language == null ? void 0 : language.isoCode) !== "en" || (language == null ? void 0 : language.isoCode) !== "en-ID" || (language == null ? void 0 : language.isoCode) == "en-AU") && (settings == null ? void 0 : settings.label_subdistrict_IND) == null ? `${selectedSubdistrict == "" ? "Pilih Kecamatan" : "Kecamatan"}` : `${selectedSubdistrict == "" ? `Pilih ${settings == null ? void 0 : settings.label_subdistrict_IND}` : settings == null ? void 0 : settings.label_subdistrict_IND}`,
              value: selectedSubdistrict,
...
//# sourceMappingURL=lineashoes-address-field.js.map
